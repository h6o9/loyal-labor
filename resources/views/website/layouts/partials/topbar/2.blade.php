@if (isset($top_header_section) && $top_header_section->top_header_section->status == 1)
    <!--===========================
        TOPBAR START
    ============================-->
    <header class="wsus__topbar wsus__topbar_2">
        <div class="container">
                    ...
                    <ul class="wsus__topbar_left d-flex flex-wrap">
                        <li>
                            <a href="javascript:;" role="button" rel="nofollow" @style('cursor: default;')>
                                <span>
                                    <img class="img-fluid w-100" src="{{ asset('website/images/location_1.webp') }}"
                                        alt="icon">
                                </span>
                ...
                <div class="col-xl-5 d-none d-xl-block">
                    @if (sectionData(sections: $top_header_section, sectionName: 'top_header_section', propertyName: 'offer_status') ==
                        ...
                        <div class="wsus__topbar_center">
                            <p><span>{{ sectionData(sections: $top_header_section, sectionName: 'top_header_section', propertyName: 'offer_label') }}</span>{{ sectionData(sections: $top_header_section, sectionName: 'top_header_section', propertyName: 'offer_text') }}
                            </p>
                        </div>
                    @endif
                </div>
