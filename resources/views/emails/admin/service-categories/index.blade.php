...
@push('js')
    ...
    <script>
        function changeServiceCategoryStatus(id) {
            $.ajax({
                ...
                error: function () {
                    ...
                    if (window.serviceCategoryTable && window.serviceCategoryTable.ajax) {
                        window.serviceCategoryTable.ajax.reload();
                    }
                }
            });
        }
        ...
        $(document).ready(function() {
            window.serviceCategoryTable = initServerDataTable('#serviceCategoryTable', "{{ route('admin.service-categories.index') }}", [
                { data: 'name', name: 'name' },
                { data: 'slug', name: 'slug' },
