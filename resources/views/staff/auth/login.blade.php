                            ...
                            <div class="col-md-6 d-none d-md-block">
                                <div class="h-100">
                                    <img class="h-100 w-100 object-fit-fill" src="{{ asset('public/website/images/logo2.jpeg') }}"
                                        alt="{{ $setting?->app_name ?? 'Loyal Labor' }}">
                                </div>
                            </div>
                            <!-- end col -->
                                    ...
                                    <div class="p-5">
                                        <div>
                                            <a class="d-block text-center" href="#">
                                                <img src="{{ asset('public/backend/img/admin-auth-bg.png') }}" alt="{{ $setting?->app_name }}"
                                                    width="220">
                                            </a>
                                        </div>

                                        <div class="mt-4">
                                            <form id="staffLoginForm" action="{{ route('staff.store-login') }}"
                                                method="POST">
                                                @csrf
                                                <div class="mb-3">
