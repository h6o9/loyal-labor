...
@section('title')
    <title>{{ $user->name }} - {{ __('Dashboard') }}</title>
@endsection
                                ...
                                <div class="card-body">
                                    @php
                                        ...
                                        foreach ($todayOrders as $key => $todayOrder) {
                                            $orderProducts = $todayOrder->items->where('vendor_id', $seller->id);
                                ...
                                <div class="card-body">
                                    @php
                                        ...
                                        foreach ($monthlyOrders as $key => $monthlyOrder) {
                                            $orderProducts = $monthlyOrder->items->where('vendor_id', $seller->id);
                                            foreach ($orderProducts as $key => $orderProduct) {
                                                $price =
                                                    $orderProduct->price * $orderProduct->qty +
                                                    $orderProduct->tax_amount;
                                ...
                                <div class="card-body">
                                    @php
                                        ...
                                        foreach ($yearlyOrders as $key => $yearlyOrder) {
                                            $orderProducts = $yearlyOrder->items->where('vendor_id', $seller->id);
                                            foreach ($orderProducts as $key => $orderProduct) {
                                                $price =
                                                    $orderProduct->price * $orderProduct->qty +
                                                    $orderProduct->tax_amount;
                                ...
                                <div class="card-body">
                                    @php
                                        ...
                                        foreach ($totalOrders as $key => $totalOrder) {
                                            $orderProducts = $totalOrder->items->where('vendor_id', $seller->id);
                                            foreach ($orderProducts as $key => $orderProduct) {
                                                $price =
                                                    $orderProduct->price * $orderProduct->qty +
                                                    $orderProduct->tax_amount;
