...
<li class="nav-item">
    <a class="nav-link" id="hand_cash-tab" data-bs-toggle="tab" href="#hand_cash_tab" role="tab"
        aria-controls="hand_cash" aria-selected="false">{{ __('Cash On Delivery') }}</a>
</li>
<li class="nav-item">
...
<li class="nav-item">
    <a class="nav-link" id="sslcommerz-tab" data-bs-toggle="tab" href="#sslcommerz_tab" role="tab"
        aria-controls="SslCommerz" aria-selected="false">{{ __('SslCommerz') }}</a>
</li>
<li class="nav-item">
    <a class="nav-link" id="crypto-tab" data-bs-toggle="tab" href="#crypto_tab" role="tab" aria-controls="Crypto"
        aria-selected="false">{{ __('Crypto') }}</a>
</li>
