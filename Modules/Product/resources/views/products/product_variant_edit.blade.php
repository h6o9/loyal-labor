    ...
    <div class="main-content">
        <section class="section">
            <x-admin.breadcrumb title="{{ __('Edit Product Variant') }}" :list="[
                ...
                __('Product Variant List') => route('admin.product.product-variant', $product->id),
                            ...
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div>
                                    <a class="btn btn-primary"
                                        href="{{ route('admin.product.product-variant', $product->id) }}"><i
                                            class="fa fa-arrow-left"></i> {{ __('Back') }}</a>
                                </div>
                            </div>
                            <div class="card-body">
                                <form action="{{ route('admin.product.product-variant.update', $variant->id) }}"
                                    method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
