...
@section('title')
    <title>{{ $product->name }} {{ __('Details') }}</title>
@endsection
                            ...
                            <div class="card-header d-flex justify-content-between">
                                ...
                                <div class="card-header-action">
                                    ...
                                    @adminCan('product.edit')
                                        <a class="btn btn-warning" href="{{ route('admin.product.edit', $product->id) }}"><i
                                        ...
                                        @if ($product->variants)
                                            <div class="container-fluid mt-5">
                                                <div class="d-flex justify-content-between mb-3">
                                                    <h5>
                                                        <a href="{{ route('admin.product.product-variant', ['id' => $product->id]) }}"
                                                            @adminCan('product.edit')
                                                            @endadminCan>{{ __('Product Variants') }}</a>
                                                        <span
                                                        ...
                                                        @if (!$product->is_flash_deal)
                                                            @adminCan('product.edit')
                                                                <a class="btn btn-success"
                                                                    href="{{ route('admin.products.product-prices', ['keyword' => $product->sku]) }}">{{ __('Update Price') }}</a>
                                                            @endadminCan

                                                            @adminCan('product.edit')
                                                                <a class="btn btn-info"
                                                                    href="{{ route('admin.products.product-inventory', ['keyword' => $product->sku]) }}">{{ __('Update Stock') }}</a>
                                                            @endadminCan
                                                        @endif
                                                    </div>
                                                </div>
