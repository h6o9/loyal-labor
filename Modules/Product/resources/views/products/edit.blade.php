                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <form class="create_product_table"
                            action="{{ route('admin.product.update', ['product' => $product->id, 'code' => $code]) }}"
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div
                                                            class="stock_status {{ $product->manage_stock && $product->stock_status == 'in_stock' ? '' : 'd-none' }} mt-3">
                                                            <div class="form-group">
                                                                <label for="stock_qty">
                                                                    {{ __('Stock Quantity') }}
                                                                </label>
                                            ...
                                            <div class="card-header d-flex justify-content-between">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input id="is_flash_deal" name="is_flash_deal" data-toggle="toggle"
                                                        ...
                                                        @checked($product->is_flash_deal == 1)>
                                                </div>
                                            </div>
                                            <div class="card-body {{ $product->is_flash_deal == 0 ? 'd-none' : '' }}"
                                                id="flash_deal_area">
                                                <div class="row">
                                                    <div class="col-md-12 flash_deal_image">
                                                        <div class="form-group">
                                                            ...
                                                            @if ($product->getRawOriginal('flash_deal_image') ?? false)
                                                                <span class="text-muted">
                                                                    <a href="{{ asset($product->flash_deal_image) }}"
                                                                        target="_blank">
                                                                        {{ __('Check Current Image') }}
                                                                    </a>
                                                                </span>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 flash_deal_start">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control start-datepicker"
                                                                id="flash_deal_start" name="flash_deal_start"
                                                                type="text"
                                                                value="{{ old('flash_deal_start', $product->flash_deal_start) }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6 flash_deal_end">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control datepicker" id="flash_deal_end"
                                                                ...
                                                                value="{{ old('flash_deal_end', $product->flash_deal_end) }}">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" id="flash_deal_price"
                                                                    ...
                                                                    value="{{ old('flash_deal_price', $product->is_flash_deal == 0 ? $product->price : $product->flash_deal_price) }}">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            @php
                                                                $qty = old('flash_deal_qty', $product->flash_deal_qty);
                                                                $qty = max(1, (int) $qty);
                                                            @endphp
