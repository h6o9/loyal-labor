...
class Kernel extends HttpKernel
{
    ...
    protected $middleware = [
        ...
        // \App\Http\Middleware\StrictContentSecurityPolicy::class,
    ...
    protected $middlewareGroups = [
        'web' => [
            ...
            \App\Http\Middleware\DatatablesRequestMiddleware::class,
            \App\Http\Middleware\VerifyCsrfToken::class,
            \Illuminate\Routing\Middleware\SubstituteBindings::class,
            \App\Http\Middleware\PreventXSSAttackMiddleware::class,
            \App\Http\Middleware\DemoModeMiddleware::class,
            \App\Http\Middleware\SetLocaleMiddleware::class,
            \App\Http\Middleware\ChangeThemeMiddleware::class,
        ],
